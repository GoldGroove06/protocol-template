...
const LogoIcon = () => {
    return(
        <svg viewBox="0 0 25 50" aria-hidden="true" class="h-12 w-12"><path className="fill-emerald-400" d="M16 8a5 5 0 0 0-5-5H5a5 5 0 0 0-5 5v13.927a1 1 0 0 0 1.623.782l3.684-2.93a4 4 0 0 1 2.49-.87H11a5 5 0 0 0 5-5V8Z"></path></svg>
    )
}
                ...
                <div className='space-y-4'>
                    ...
                    <div className='space-y-3'>
                        <div className='pl-4 space-y-2'>
                            <div className='text-slate-1000'>Introduction</div>
                            <div className='pl-8'>
                                Guides<br></br>
                                Resources
                            </div>
